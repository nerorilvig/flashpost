...
<head>
  ...
  <script src="./javascript/navbarctrl.js"></script>
  ...
  <nav class="navbar fixed-top navbar-expand-lg" id="navtop" >
    <div class="nav-contents">
      <div class="navbtn-wrapper">
        <div class="nav-btn">button1</div>
        <div class="nav-btn">button2</div>
        <div class="nav-btn">button3</div>
        <div class="nav-btn">button4</div>
      </div>
      <!--
